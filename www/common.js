...
/***/ "./src/app/card/card-favorite/card-favorite.module.ts":
/*!************************************************************!*\
  !*** ./src/app/card/card-favorite/card-favorite.module.ts ***!
  \************************************************************/
/*! exports provided: CardFavoritePageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CardFavoritePageModule", function() { return CardFavoritePageModule; });
...
/* harmony import */ var _card_favorite_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./card-favorite.page */ "./src/app/card/card-favorite/card-favorite.page.ts");
...
var routes = [
    {
        path: '',
        component: _card_favorite_page__WEBPACK_IMPORTED_MODULE_5__["CardFavoritePage"]
    }
];
var CardFavoritePageModule = /** @class */ (function () {
    function CardFavoritePageModule() {
    }
    CardFavoritePageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_card_favorite_page__WEBPACK_IMPORTED_MODULE_5__["CardFavoritePage"]]
        })
    ], CardFavoritePageModule);
    return CardFavoritePageModule;
}());
...
/***/ "./src/app/card/card-favorite/card-favorite.page.html":
/*!************************************************************!*\
  !*** ./src/app/card/card-favorite/card-favorite.page.html ***!
  \************************************************************/
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>card-favorite</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n      <ion-item [href]=\"'/tabs/(card:card/'+card.cardId +')'\" *ngFor=\"let card of favoriteCardList\">\n          <ion-label>\n            <h2>{{card.name}}</h2>\n          </ion-label>\n      </ion-item>\n  </ion-list>\n</ion-content>\n"

/***/ }),

/***/ "./src/app/card/card-favorite/card-favorite.page.scss":
/*!************************************************************!*\
  !*** ./src/app/card/card-favorite/card-favorite.page.scss ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/card/card-favorite/card-favorite.page.ts":
/*!**********************************************************!*\
  !*** ./src/app/card/card-favorite/card-favorite.page.ts ***!
  \**********************************************************/
/*! exports provided: CardFavoritePage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CardFavoritePage", function() { return CardFavoritePage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_card_favorite_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/card-favorite.store */ "./src/app/card/shared/card-favorite.store.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CardFavoritePage = /** @class */ (function () {
    function CardFavoritePage(cardStore) {
        var _this = this;
        this.cardStore = cardStore;
        this.favoriteCardList = [];
        this.Subcription = this.cardStore.favoriteCard.subscribe(function (favoriteCards) {
            _this.favoriteCardList = _this.getFavoriteCardList(favoriteCards);
        });
    }
    CardFavoritePage.prototype.ionViewDidLeave = function () {
        this.Subcription.unsubscribe();
    };
    CardFavoritePage.prototype.ngOnInit = function () {
    };
    CardFavoritePage.prototype.getFavoriteCardList = function (favoriteCards) {
        if (favoriteCards) {
            return Object.keys(favoriteCards)
                .filter(function (key) { return favoriteCards[key]; })
                .map(function (key) { return favoriteCards[key]; });
        }
        return [];
    };
    CardFavoritePage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-card-favorite',
            template: __webpack_require__(/*! ./card-favorite.page.html */ "./src/app/card/card-favorite/card-favorite.page.html"),
            styles: [__webpack_require__(/*! ./card-favorite.page.scss */ "./src/app/card/card-favorite/card-favorite.page.scss")],
        }),
        __metadata("design:paramtypes", [_shared_card_favorite_store__WEBPACK_IMPORTED_MODULE_1__["favoriteCardStorage"]])
    ], CardFavoritePage);
    return CardFavoritePage;
}());
...
/***/ "./src/app/card/shared/card-favorite.store.ts":
/*!****************************************************!*\
  !*** ./src/app/card/shared/card-favorite.store.ts ***!
  \****************************************************/
/*! exports provided: favoriteCardStorage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "favoriteCardStorage", function() { return favoriteCardStorage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var favoriteCardStorage = /** @class */ (function () {
    function favoriteCardStorage(storage) {
        this.storage = storage;
        this._favoriteCardSubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"]({});
        this.loadInitialData();
    }
    Object.defineProperty(favoriteCardStorage.prototype, "favoriteCard", {
        get: function () {
    ...
    favoriteCardStorage.prototype.loadInitialData = function () {
        var _this = this;
        this.storage.get('favoriteCards').then(function (favoriteCards) {
            _this._favoriteCardSubject.next(favoriteCards || {});
        });
    };
    favoriteCardStorage.prototype.toggleCard = function (cards) {
        var _this = this;
        var favoritecard$ = this._favoriteCardSubject.getValue();
        if (cards.favorite) {
        ...
        this.storage.set('favoriteCards', favoritecard$).then(function () {
            _this._favoriteCardSubject.next(favoritecard$);
        });
    };
    favoriteCardStorage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])
    ], favoriteCardStorage);
    return favoriteCardStorage;
}());
