...
var map = {
	"./card/card-favorite/card-favorite.module": [
...
/* harmony import */ var _shared_service_fcm_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/service/fcm.service */ "./src/app/shared/service/fcm.service.ts");
/* harmony import */ var _shared_service_toast_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/service/toast.service */ "./src/app/shared/service/toast.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, fcm, toast) {
    ...
    AppComponent.prototype.notificationSetup = function () {
        //  this.fcm.getToken();
        //  this.fcm.oNotifications().subscribe(
        //    (msg)=>{
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"],
            ...
            _shared_service_fcm_service__WEBPACK_IMPORTED_MODULE_4__["FcmService"],
            _shared_service_toast_service__WEBPACK_IMPORTED_MODULE_5__["ToastService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _shared_service_toast_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/service/toast.service */ "./src/app/shared/service/toast.service.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _shared_service_loader_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/service/loader.service */ "./src/app/shared/service/loader.service.ts");
/* harmony import */ var _shared_service_alert_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./shared/service/alert.service */ "./src/app/shared/service/alert.service.ts");
...
/* harmony import */ var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/firebase/ngx */ "./node_modules/@ionic-native/firebase/ngx/index.js");
/* harmony import */ var _shared_service_fcm_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./shared/service/fcm.service */ "./src/app/shared/service/fcm.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(config),
                _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_13__["AngularFirestoreModule"]
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _shared_service_loader_service__WEBPACK_IMPORTED_MODULE_10__["LoaderService"],
                _shared_service_toast_service__WEBPACK_IMPORTED_MODULE_7__["ToastService"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _shared_service_alert_service__WEBPACK_IMPORTED_MODULE_11__["AlertService"],
                _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_14__["Firebase"],
                _shared_service_fcm_service__WEBPACK_IMPORTED_MODULE_15__["FcmService"],
...
var AlertService = /** @class */ (function () {
    ...
    AlertService.prototype.presentAlert = function (message) {
...
/***/ "./src/app/shared/service/fcm.service.ts":
/*!***********************************************!*\
  !*** ./src/app/shared/service/fcm.service.ts ***!
  \***********************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic-native/firebase/ngx */ "./node_modules/@ionic-native/firebase/ngx/index.js");
...
var FcmService = /** @class */ (function () {
    function FcmService(firebase, platform, afs) {
    ...
    FcmService.prototype.saveToken = function (token) {
        if (!token)
            return;
        var deviceRef = this.afs.collection('devices');
        var data = {
            token: token,
            userId: 'testUserId'
        };
    ...
    FcmService.prototype.oNotifications = function () {
        return this.firebase.onNotificationOpen();
    };
    FcmService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_1__["Firebase"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]])
    ], FcmService);
    return FcmService;
}());
...
/***/ "./src/app/shared/service/loader.service.ts":
/*!**************************************************!*\
  !*** ./src/app/shared/service/loader.service.ts ***!
  \**************************************************/
...
var LoaderService = /** @class */ (function () {
    function LoaderService(LoadCtrl) {
    ...
    LoaderService.prototype.dissmisLoading = function () {
        if (this.loader) {
            this.loader.dismiss();
        }
    };
...
var ToastService = /** @class */ (function () {
    ...
    ToastService.prototype.presentToastWithOptions = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
module.exports = __webpack_require__(/*! /Users/user/Desktop/heartStoneLib/src/main.ts */"./src/main.ts");
